...
namespace Sloos.Common.Test
{
    ...
    {
        #region SacramentoBee_RealEstate
        // The Sacramento real estate transactions file is a list of real estate transactions in the
        // Sacramento area reported over a five-day period, as reported by the Sacramento Bee.
        // Note that this file has address level information that you can choose to geocode, or you
        // can use the existing latitude/longitude in the file.
        public static string SacramentoBee_RealEstate = @"street,city,zip,state,beds,baths,sq__ft,type,sale_date,price,latitude,longitude
...
230 CANDELA CIR,SACRAMENTO,95835,CA,3,2,1541,Residential,Wed May 21 00:00:00 EDT 2008,260000,38.656251,-121.547572";
        ...
        #endregion SacramentoBee_RealEstate
    }
}
