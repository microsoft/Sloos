...
{
    public sealed class MappingRelationshipForeignKeyMatcherWithOptional : IMappingRelationshipForeignKeyMatcher
    {
        private readonly CodeGenEscaper codeGenEscaper;

        public MappingRelationshipForeignKeyMatcherWithOptional(CodeGenEscaper codeGenEscaper)
        {
